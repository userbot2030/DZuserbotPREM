...
ADMIN1_ID = list(map(int, getenv("ADMIN1_ID", "1337085565").split()))
ADMIN2_ID = list(map(int, getenv("ADMIN2_ID", "1337085565").split()))
ADMIN3_ID = list(map(int, getenv("ADMIN2_ID", "1337085565").split()))
ADMIN4_ID = list(map(int, getenv("ADMIN2_ID", "1337085565").split()))


ADMIN1_ID.append(1337085565)
ADMIN2_ID.append(1337085565)
ADMIN3_ID.append(1337085565)
ADMIN4_ID.append(1337085565)
...
REPO_URL = getenv("REPO_URL", "https://github.com/MS-DZULQURNAIN/DZuserbotPREM")
CMD_HNDLR = getenv("CMD_HNDLR", ".")
SUPPORT = int(getenv("SUPPORT", "-1001549421677"))
CHANNEL = int(getenv("CHANNEL", "-1001549421677"))
